<%-- 
    Document   : UpdateServiceCate
    Created on : Oct 28, 2021, 10:16:43 PM
...
<div class="modal-dialog">
    <div class="modal-content">
        <form action="UpdateServiceCate" method="POST">
            <div class="modal-header">						
                <h4 class="modal-title">Update Service Category <i class="fas fa-user-friends"></i></h4>
            </div>
            <div class="modal-body">					
                <div class="form-group">
                    <label>Post Category ID</label>
                    <input type="text" name="scID" value="${SerCate.scID}" readonly/>
                </div>
                <div class="form-group">
                    <label>Post Category Name</label>
                    <input name="scCateName" type="text" value="${SerCate.scCateName}" class="form-control" required>
                </div>                    
            </div>
