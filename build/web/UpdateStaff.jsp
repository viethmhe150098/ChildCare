        ...
        <div class="modal-content">
            <form action="UpdateStaff" method="post">
                <div class="modal-header">						
                    <h4 class="modal-title">Update Staff <i class="fas fa-user-friends"></i></h4>
                    <!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>-->
                </div>
                <div class="modal-body">					
                    <div class="form-group">
                        <label>stID</label>
                        <input type="text" name="cid" value="${listUser.stID}" readonly/>
                    </div>
                    <div class="form-group">
                        <label>First Name</label>
                        <input name="firstname" type="text" value="${listUser.first_name}" class="form-control" required>
                    </div>
                      <div class="form-group">
                        <label>aID</label>
                        <input name="aID" type="text" value="${listUser.aID}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Last Name</label>
                        <input name="lastname" type="text" value="${listUser.last_name}" class="form-control" required>
                    </div>
                   
<div class="form-group">
                        <label>Age</label>
                        <input name="age" type="text" value="${listUser.age}" class="form-control" required>
                    </div>
                    <div >
                        <p style="color: grey; font-size: 20px">Gender</p>
                        <div class="p-t-10">
                            <label class="radio-container m-r-45">Male
                                <input type="radio" name="gender" value="1" ${listUser.gender==1?"checked":""}>
                                <span class="checkmark"></span>
                            </label>
                            <label class="radio-container">Female
                                <input type="radio" name="gender" value="0" ${listUser.gender==0?"checked":""}>
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="text" value="${listUser.email}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Tel <i class="fas fa-phone"></i>
                        </label>
                        <input name="phone" type="text" value="${listUser.phone}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <input name="user" type="text" value="${listUser.username}" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input name="pass" type="text" value="${listUser.password}" class="form-control" required>
                    </div>
                 
                    <div class="form-group">
                        <label>Address</label>
                        <input name="address" value="${listUser.address}" class="form-control" required></input>
                    </div>
                                        <div class="form-group">
                                            <label>Role (3 : Staff Other : Not Staff)</label>
                                            <input name="role" type="text" value="${listUser.role}" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>isDoctor (1 : Doctor Other : Not Doctor)</label>
                                            <input name="doctor" type="text" value="${listUser.isDoctor}" class="form-control" required>
                                        </div>
                </div>
