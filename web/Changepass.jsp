    ...
    <body class="clinic_version">
        ...
        <div class="contain">
            ...
            <div class="leftside_bar">
             ...
             <div class="contain">
            <div class="wrapper">
                <form action="ChangePassControl" method="POST">
        <table >
            
            <tbody>
                <tr>
                    <td>Old Password:</td>
                    <td><input type="password" name="old" value="" style="color : rgba(0, 181, 204, 1);" /></td>
                </tr>
                <p class="text-danger">${mess}</p>
                <tr>
                    <td>New Password:</td>
                    <td><input type="password" name="new" value="" style="color : rgba(0, 181, 204, 1);" /></td>
                </tr>
                <tr>
                    <td>New Password again:</td>
                    <td><input type="password" name="newa" value="" style="color : rgba(0, 181, 204, 1);" /></td><br>
