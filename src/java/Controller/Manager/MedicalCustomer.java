 ...
 * @author ADMIN
 */
@WebServlet(name = "MedicalCustomer", urlPatterns = {"/MedicalCustomer"})
public class MedicalCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      Customer cus = (Customer) session.getAttribute("customer_account");
        String cID = String.valueOf(cus.getcID());
        ...
        String sql = "select b.reID, Convert(varchar(10),b.date,103) as 'dd/MM/yyyy', d.sname, f.meName, f.meDes\n"
          ...
          ResultSet rs1 = dbconn.getData(sql);
            request.setAttribute("medical", rs1);
