 ...
 * @author ADMIN
 */
@WebServlet(name = "SearchByService", urlPatterns = {"/SearchByService"})
public class SearchByService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         String medicalSearch = request.getParameter("nameService");
         DBConnect dbconn = new DBConnect();
            String sql = "select b.reID, Convert(varchar(10),b.date,103) as 'dd/MM/yyyy', d.sname, f.meName, f.meDes\n"
                    ...
                    + "where b.reID=1 and d.sname like '%" + medicalSearch + "%'";
